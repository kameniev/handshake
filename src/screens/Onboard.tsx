...
import {TouchableOpacity, View, StatusBar, StyleSheet, Text} from 'react-native'
        ...
        switch (item.id){
            ...
            case 3:
                return(
                    ...
                    locations={[0.1153, 0.9143]}><MainImage source={require('../assets/images/2.jpg')}/></ImageWrapper>
                    ...
                    <NextButton onPress={handleDoneFinish}><StyledGradient
            colors={['#36D1DC', '#5B86E5']}
            start={{x: 0, y: 0.5}}
            end={{x: 1, y: 0.5}}
            locations={[0.1153, 0.9143]}
            ><NextButtonText>Начать</NextButtonText></StyledGradient></NextButton>
