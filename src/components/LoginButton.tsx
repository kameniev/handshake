...
function LoginButton() {
    ...
    return(
        <LoginContainer onPress={handleClick}><StyledGradient
        colors={['#36D1DC', '#5B86E5']}
        start={{x: 0, y: 0.5}}
        end={{x: 1, y: 0.5}}
        locations={[0.1153, 0.9143]}
        ><TextWrapper><LoginButtonText>Войти через instagram</LoginButtonText></TextWrapper><Flag><Icon name={'Insta'} width={20}/></Flag></StyledGradient></LoginContainer>
    )
}
